...
export default function Sidebarhelp(){
    return (
        <div className="h-42.25 w-54.5 bg-[#4FD1C5] rounded-xl flex flex-col px-3 py-2">
            <div className="p-3 rounded-full bg-[#4FD1C5]"><HiQuestionMarkCircle size={40} color="white"/></div>
            ...
            <button className="w-46.5 h-8.75 bg-white rounded-xl font-bold cursor-pointer">DOCUMENTATION</button>
